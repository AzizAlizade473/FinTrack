              ...
              {filtered.map(t => (
                <tr key={t.id} className="hover:bg-hover transition-colors group">
                  ...
                  <td className="px-6 py-4 text-center">
                    <button onClick={() => handleDelete(t.id)} className="text-[#9ca3af] hover:text-red opacity-0 group-hover:opacity-100 transition-all p-1.5 rounded-md hover:bg-red/10 cursor-pointer" title="Delete">
